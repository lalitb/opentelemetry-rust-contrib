...
mod tests {
    ...
    use crate::payload_encoder::central_blob::CentralBlob;
    ...
    fn create_payload(fields: Vec<FieldDef>, row_data: Vec<u8>) -> Vec<u8> {
        ...
        let schema = BondEncodedSchema::from_fields("MdsContainer", "testNamespace", fields);
        let schema_id = blob.add_schema(schema);

        blob.add_event(schema_id, 5, "basename".to_string(), row_data);
    ...
    fn test_bond_encoding() {
        // Updated expected bytes without MD5 hash (16 bytes removed from schema section)
        let expected: &[u8] = &[
            ...
            0x00, 0x00, 0x00, 0x00, // MD5 hash removed from here (16 bytes removed)
            ,
            ...
            ,
            ...
            0x00, 0x73, 0x00, 0x65, 0x00, 0x6e, 0x00, 0x61, 0x00, 0x6d, 0x00, 0x65, 0x00, 0x33,
            0x00, 0x00, 0x00, 0x53, 0x50, 0x01, 0x00, 0x6f, 0x12, 0x83, 0xc0, 0xca, 0x21, 0x09,
            0x40, 0x2a, 0x00, 0x00, 0x00, 0x79, 0xdf, 0x0d, 0x86, 0x48, 0x70, 0x00, 0x00, 0x01,
            0x0b, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00,
            0x20, 0x00, 0x42, 0x00, 0x6f, 0x00, 0x6e, 0x00, 0x64, 0x00, 0x21, 0x00, 0xde, 0xc0,
            0xad, 0xde, 0xde, 0xc0, 0xad, 0xde,
        ];
